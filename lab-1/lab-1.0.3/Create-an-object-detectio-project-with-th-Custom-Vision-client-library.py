# Documentacion  https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/quickstarts/object-detection?tabs=linux%2Cvisual-studio&pivots=programming-language-python
